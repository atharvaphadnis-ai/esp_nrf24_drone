...
// This code is derived from pratik phadte Github repository, This is a test code, the owner is not responsble for damages.
// Thanks pratik phadte for helping me in my drone project.
// credit = Pratik Phadte
#include <Wire.h>
